...
<?php
			if(isset($_POST['savequest'])){
				...
				$replace = mysqli_query($connect,"UPDATE questions SET question='$question', a='$a', b='$b', c='$c', d='$d', answerki='$answer' WHERE numassign='$hi' AND qset='C'");
				$key_replace = mysqli_query($connect,"UPDATE answer_key SET a$hi='$answer' WHERE qset='C'");
				}
